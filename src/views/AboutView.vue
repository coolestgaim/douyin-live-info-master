    ...
    <div class="card about-card">
      <div class="app-info">
        ...
        <div>
          ...
          <div class="app-version">V 2.9.35 — 实时弹幕监听 · 直播录制 · 快捷控场 · 双主题</div>
        </div>
      </div>
...
<style scoped>
.about-page { padding: 16px 20px 20px; height: 100%; overflow-y: auto; }

.about-card { padding: 24px; max-width: 600px; margin: 0 auto; }
